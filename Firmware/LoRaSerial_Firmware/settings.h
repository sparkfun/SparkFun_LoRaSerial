...
{ //#, Width - Computed with:
  ...
  TRIGGER_COMPLETE,
  TRIGGER_RADIO_RESET,
  TRIGGER_P2P_LINK_DOWN,
  TRIGGER_P2P_WAIT_TX_PING_DONE,
  TRIGGER_P2P_WAIT_ACK_1,
  TRIGGER_P2P_WAIT_ACK_2,
  TRIGGER_P2P_WAIT_TX_ACK_1_DONE,
  TRIGGER_P2P_WAIT_TX_ACK_2_DONE,
  TRIGGER_P2P_LINK_UP,
  TRIGGER_HOP_TIMER_START,
  TRIGGER_HOP_TIMER_STOP,
  TRIGGER_HEARTBEAT,
  TRIGGER_P2P_LINK_UP_HB_DO_NOTHING,
  TRIGGER_HOPPING,
  TRIGGER_P2P_LINK_UP_WAIT_ACK,
  TRIGGER_P2P_LINK_UP_WAIT_ACK_DONE,
  TRIGGER_P2P_LINK_UP_WAIT_TX_DONE,
  TRIGGER_SYNC_CHANNEL,
  TRIGGER_P2P_LINK_UP_ACK_HB,
